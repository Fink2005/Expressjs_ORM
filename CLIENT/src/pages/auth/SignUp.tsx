...
export default function SignUp() {
  ...
  return (
    <div className="">
      ...
      >
        <div className="w-[450px] h-[620px] rounded-3xl shadow-2xl bg-white flex flex-col items-center p-5 sm:p-10">
          <div>{icon}</div>
          <div>
            <h1 className="text-2xl text-center text-black/80 font-bold">
              Đăng ký Pinterest để khám phá nhiều hơn
            </h1>
          </div>
